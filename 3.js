...
function calcularFaturamento(faturamento) {
  ...
  let media = diasValidos > 0 ? total / diasValidos : 0;
  let acimaDaMedia = 0;
  ...
  return {
    maiorFaturamento: maiorValor,
    menorFaturamento: menorValor,
    diasAcimaDaMedia: acimaDaMedia,
  };
}

let faturamentoMensal = JSON.parse(jsonString);
